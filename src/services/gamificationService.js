 ...
 */
export const fetchEmployeeGamificationStats = async (employeeId) => {
  const response = await axiosInstance.get(`/gamification/statistics/${employeeId}`);
 ...
 */
export const fetchLevelProgression = async () => {
